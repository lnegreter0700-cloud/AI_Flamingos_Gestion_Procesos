...
- **Propósito:** Estructurar el conocimiento extraído bajo las plantillas del negocio e inyectar los datos en los entregables finales (`Ficha_de_Proceso.md` y `Matriz_de_Riesgos.md`).
- **Directorio de Reglas:** `docs/specs/templates/` (`Plantilla_Ficha_de_Proceso.md`, `Plantilla_Matriz_de_Riesgos.md`), garantizando compatibilidad con los estilos de Google Docs definidos en `scripts/`.
...
- **Flujo de Trabajo:**
  ...
  4. Guardar ambos entregables con la nomenclatura:
     - `SOP_[Nombre_Proceso]_Ficha_de_Proceso.md`
     - `SOP_[Nombre_Proceso]_Matriz_de_Riesgos.md`
     en `docs/specs/procesos/`.

## 3. AGENTE: `Inventory_Controller`
- **Propósito:** Verificar los procesos creados dentro de `docs/specs/procesos/` y compilar el inventario general de procesos. Este agente siempre se ejecuta como paso final tras completarse las fichas pendientes.
- **Directorio de Entrada:** `docs/specs/procesos/`
- **Directorio de Reglas:** `docs/specs/templates/Plantilla_Inventario_de_Procesos.md`
- **Directorio de Salida:** `docs/output/`
- **Flujo de Trabajo:**
  1. Recorrer las fichas de proceso en `docs/specs/procesos/`.
  2. Generar el archivo consolidado `SOP_Inventario_de_Procesos.md`.
